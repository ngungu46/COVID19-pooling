...
def calculation():
    ...
    if success_rate_test == 0.99:
        ...
        optimal_group_sizes[0.0075] = [1, 12, 32, 32]
        optimal_group_sizes[0.01] = [1, 10, 32, 27]
        optimal_group_sizes[0.025] = [1, 7, 16, 14]
        optimal_group_sizes[0.05] = [1, 5, 8, 10]
        optimal_group_sizes[0.1] = [1, 4, 4, 7]
        optimal_group_sizes[0.15] = [1, 3, 4, 6]
        optimal_group_sizes[0.2] = [1, 3, 2, 5]
        optimal_group_sizes[0.25] = [1, 3, 2, 5]
        optimal_group_sizes[0.3] = [1, 3, 1, 1]
    elif success_rate_test == 0.95:
        optimal_group_sizes[0.001] = [1, 26, 32, 32]
        optimal_group_sizes[0.0025] = [1, 22, 32, 32]
        optimal_group_sizes[0.005] = [1, 15, 32, 32]
        optimal_group_sizes[0.0075] = [1, 13, 32, 31]
        optimal_group_sizes[0.01] = [1, 11, 32, 25]
        optimal_group_sizes[0.025] = [1, 7, 31, 15]
        optimal_group_sizes[0.05] = [1, 5, 32, 10]
        optimal_group_sizes[0.1] = [1, 4, 8, 7]
        optimal_group_sizes[0.15] = [1, 3, 4, 6]
        optimal_group_sizes[0.2] = [1, 3, 2, 5]
        optimal_group_sizes[0.25] = [1, 3, 2, 5]
        ...
        optimal_group_sizes[0.001] = [1, 32, 32, 32]
        optimal_group_sizes[0.0025] = [1, 21, 32, 32]
        optimal_group_sizes[0.005] = [1, 18, 32, 32]
        optimal_group_sizes[0.0075] = [1, 15, 32, 32]
        optimal_group_sizes[0.01] = [1, 12, 32, 31]
        optimal_group_sizes[0.025] = [1, 8, 32, 18]
        optimal_group_sizes[0.05] = [1, 6, 32, 12]
        optimal_group_sizes[0.1] = [1, 5, 32, 8]
        optimal_group_sizes[0.15] = [1, 4, 32, 7]
        optimal_group_sizes[0.2] = [1, 4, 32, 32]
        optimal_group_sizes[0.25] = [1, 4, 32, 32]
        optimal_group_sizes[0.3] = [1, 30, 32, 32]
